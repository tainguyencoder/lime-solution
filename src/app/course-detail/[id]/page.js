...
import {PiShoppingCart,PiBookOpenText,GoClock,FaSignal,BiCube,BiBookReader, LiaClipboardListSolid, GoLock} from '../../assets/icons/icons'
...
export default function CourseDetail(props){
    ...
    const data = courcesData.find((course)=>course?.id === parseInt(props?.params?.id || 0));
