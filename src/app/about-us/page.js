        ...
        <div className="container relative">
          <div className="grid grid-cols-1 pb-8 text-center mt-10">
            ...
            <p className="text-slate-300 text-lg max-w-xl mx-auto">
              With the desire to contribute to enhancing position on the global
              information technology map, Lime Solution aims to bring innovative
              technology to life by taking advantage of the technical labor
              resources in Vietnam, and vision to become the leading IT company
              in Asia
            </p>
          </div>
        </div>
            ...
            <div className="lg:col-span-7 md:col-span-6">
              <div className="lg:ms-5">
                ...
                <p className="text-slate-400 max-w-xl">
                  At Lime Solution, we are your dedicated IT partner, delivering
                  tailored technology solutions with innovation, reliability,
                  and customer satisfaction at the core. Specializing in
                  software development, cloud migration, and IoT solutions, we
                  aim to empower your business for success.
                </p>
