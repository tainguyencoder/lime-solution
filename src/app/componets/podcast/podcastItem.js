                    ...
                    <div className="tiny-slide" key={index}>
                        <div className="group relative rounded-md shadow dark:shadow-gray-800 overflow-hidden m-3">
                            <div className="relative">
                                ...
                                <Link href="#!" onClick={() => setOpen(true)} scroll={false} className="lightbox size-8 inline-flex items-center justify-center rounded-full bg-white border border-white text-indigo-600 absolute top-3 end-3"><i className="mdi mdi-play"></i></Link>
