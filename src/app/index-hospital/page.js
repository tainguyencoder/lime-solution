                        ...
                        <table className="w-full text-sm text-start">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td className="p-3 border border-gray-100 dark:border-gray-700">
                                        <div className="flex items-center mb-3">
                                            <Image src="/images/client/01.jpg" width={48} height={48} className="size-12 rounded-full shadow" alt="" />
                                            <div className="ms-3">
                                    ...
                                    <td className="p-3 border border-gray-100 dark:border-gray-700">
                                        <div className="flex items-center mb-3">
                                            <Image src="/images/client/03.jpg" width={46} height={46} className="size-12 rounded-full shadow" alt="" />
                                            <div className="ms-3">
                                ...
                                <tr>
                                    ...
                                    <td className="p-3 border border-gray-100 dark:border-gray-700">
                                        <div className="flex items-center mb-3">
                                            <Image src="/images/client/02.jpg" width={46} height={46} className="size-12 rounded-full shadow" alt="" />
                                            <div className="ms-3">
                                    ...
                                    <td className="p-3 border border-gray-100 dark:border-gray-700">
                                        <div className="flex items-center mb-3">
                                            <Image src="/images/client/05.jpg" width={46} height={46} className="size-12 rounded-full shadow" alt="" />
                                            <div className="ms-3">
                                    ...
                                    <td className="p-3 border border-gray-100 dark:border-gray-700">
                                        <div className="flex items-center mb-3">
                                            <Image src="/images/client/04.jpg" width={46} height={46} className="size-12 rounded-full shadow" alt="" />
                                            <div className="ms-3">
                                ...
                                <tr>
                                    ...
                                    <td className="p-3 border border-gray-100 dark:border-gray-700">
                                        <div className="flex items-center mb-3">
                                            <Image src="/images/client/06.jpg" width={46} height={46} className="size-12 rounded-full shadow" alt="" />
                                            <div className="ms-3">
