        ...
        <section className="relative md:py-60 py-36 bg-center bg-no-repeat bg-cover jarallax bg-fixed " style={{backgroundImage:"url('/images/spa/bg.jpg')"}}>
            ...
            <div className="container relative">
                <div className="grid grid-cols-1 text-center mt-10">
                    <h5 className="font-eb_garamond text-white text-xl font-medium wow animate__animated animate__fadeInUp" data-wow-delay=".1s">Discover a truly relaxing experience</h5>
        ...
        <section className="relative md:py-24 py-16">
                       ...
                       return(
                            <div key={index} className="relative overflow-hidden h-fit">
                                ...
                                <div className="absolute p-6 bottom-0 start-0 end-0">
                                    ...
                                    <Link href="#" className="font-semibold font-eb_garamond text-white uppercase tracking-wide inline-flex items-center">{item.desc}<FiArrowUpRight className="ms-1 w-5 h-5"/></Link>
                                </div>
                            </div>
                       )
                   })} 
                ...
                <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                    ...
                    <div className="lg:col-span-7 md:col-span-6 mt-8 md:mt-0">
                        <div className="lg:ms-6">
                            ...
                            <h3 className="mb-4 md:text-4xl md:leading-normal text-3xl leading-normal font-eb_garamond font-medium">Incredible Experience</h3>
            ...
            <div className="container relative md:mt-24 mt-16 pt-16">
                <div className="grid grid-cols-1 pb-8 text-center">
                    ...
                    <h3 className="mb-4 md:text-4xl md:leading-normal text-3xl leading-normal font-eb_garamond font-medium">Our Services</h3>
                                ...
                                <div className="flex " key={index}>
                                    ...
                                    <div className="ms-2 w-full">
                                        <div className="flex justify-between pb-2 border-b border-gray-100 dark:border-gray-800">
                                            <Link href="#" className="font-eb_garamond hover:text-indigo-600 text-xl font-semibold">{data.type}</Link>
        ...
        <section className="relative md:py-24 py-16">
            <div className="container relative">
                <div className="grid grid-cols-1 pb-8 text-center">
                    ...
                    <h3 className="mb-4 md:text-4xl md:leading-normal text-3xl leading-normal font-eb_garamond font-medium">What Our Users Say</h3>
            ...
            <div className="container relative md:mt-24 mt-16">
                <div className="grid grid-cols-1 pb-8 text-center">
                    ...
                    <h3 className="mb-4 md:text-4xl md:leading-normal text-3xl leading-normal font-eb_garamond font-medium">Management Team</h3>
                            ...
                            <div key={index} className="lg:col-span-3 md:col-span-6">
                                <div className="group text-center">
                                    ...
                                    <div className="content mt-3">
                                        <Link href="#" className="text-xl font-semibold font-eb_garamond hover:text-indigo-600 transition-all duration-500 ease-in-out">{item.name}</Link>
            ...
            <div className="container relative md:mt-24 mt-16">
                <div className="grid grid-cols-1 pb-8 text-center">
                    ...
                    <h3 className="mb-4 md:text-4xl md:leading-normal text-3xl leading-normal font-eb_garamond font-medium">Blog Or News</h3>
